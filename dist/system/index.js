System.register(['aurelia-logging', 'aurelia-metadata', 'aurelia-templating'], (function (exports) {
    'use strict';
    var LogManager, metadata, BehaviorPropertyObserver, BindableProperty, HtmlBehaviorResource;
    return {
        setters: [function (module) {
            ...
            BehaviorPropertyObserver = module.BehaviorPropertyObserver;
            BindableProperty = module.BindableProperty;
            HtmlBehaviorResource = module.HtmlBehaviorResource;
        }],
        execute: (function () {

            exports({
                createTypedBindable: createTypedBindable,
                createTypedObservable: createTypedObservable,
                mapCoerceFunction: mapCoerceFunction,
                usePropertyTypeForBindable: usePropertyType$1,
                usePropertyTypeForObservable: usePropertyType
            });

            var coerceFunctions = exports('coerceFunctions', {
                none: function (a) {
                    return a;
                },
                number: function (a) {
            ...
            var coerceFunctionMap = exports('coerceFunctionMap', new Map([
                [Boolean, 'boolean'],
                [String, 'string'],
                [Date, 'date'],
                [Number, 'number'],
            ...
            var bindable = exports('bindable', function bindable(nameOrTargetOrConfig, key, descriptor) {
            ...
            var observable = exports('observable', function observable(nameOrTargetOrConfig, key, descriptor) {
